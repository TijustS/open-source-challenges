...
sed -i "s|__REPO_URL__|${REPO_URL}|g" adventures/echoes-lost-in-orbit/expert/manifests/appset.yaml

kubectl apply -n argocd -f adventures/echoes-lost-in-orbit/expert/manifests/appset.yaml
...
sed -i 's|example-hotrod:1.75.0|example-hotrod:1.76.0|g' adventures/echoes-lost-in-orbit/expert/manifests/hotrod/rollout.yaml
git add adventures/echoes-lost-in-orbit/expert/manifests/hotrod/rollout.yaml
