...
sed -i "s|__REPO_URL__|${REPO_URL}|g" adventures/echoes-lost-in-orbit/intermediate/manifests/appset.yaml

kubectl apply -n argocd -f adventures/echoes-lost-in-orbit/intermediate/manifests/appset.yaml
...
sed -i 's|podinfo:6.8.0|podinfo:6.9.3|g' adventures/echoes-lost-in-orbit/intermediate/manifests/base/rollout.yaml
git add adventures/echoes-lost-in-orbit/intermediate/manifests/base/rollout.yaml
