...
```
adventures/echoes-lost-in-orbit/expert/manifests/
```
...
```bash
git add adventures/echoes-lost-in-orbit/expert/manifests/
...
> `adventures/echoes-lost-in-orbit/expert/manifests/appset.yaml` to point to your branch.
...
```bash
adventures/echoes-lost-in-orbit/expert/smoke-test.sh
```
